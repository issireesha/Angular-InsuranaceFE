...
@Component({
  selector: 'app-underwriterdata',
  templateUrl: './underwriterdata.component.html',
  styleUrls: ['./underwriterdata.component.css']
})
export class UnderwriterdataComponent implements OnInit {
...
constructor(private actRoute:ActivatedRoute,private service:PendinginsuranceService,
 ...
 private children:ChildrenService,private parent:ParentsService,private router:Router) {}
